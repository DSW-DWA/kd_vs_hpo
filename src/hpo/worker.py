...
from src.common.dataloader import build_cifar10_datasets
from src.hpo.config import HPOExperimentConfig, PrunerName, SamplerName
from src.hpo.optimization import run_study
...
def run_study_process(
    ...
    train_dataset, val_dataset, _ = build_cifar10_datasets(task.experiment.train)
    return run_study(
